...
public class AOrderedListSerializerDeserializer extends AbstractListSerializerDeserializer<AOrderedList> {
    ...
    public AOrderedListSerializerDeserializer(AOrderedListType listType) {
        super(listType);
    ...
    public AOrderedList deserialize(DataInput in) throws HyracksDataException {
        return new AOrderedList((AOrderedListType) listType, readList(in));
    }
