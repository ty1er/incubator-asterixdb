...
public class AUnorderedListSerializerDeserializer extends AbstractListSerializerDeserializer<AUnorderedList> {
    ...
    public AUnorderedListSerializerDeserializer(AUnorderedListType listType) {
        super(listType);
    ...
    public AUnorderedList deserialize(DataInput in) throws HyracksDataException {
        return new AUnorderedList((AUnorderedListType) listType, readList(in));
    }
