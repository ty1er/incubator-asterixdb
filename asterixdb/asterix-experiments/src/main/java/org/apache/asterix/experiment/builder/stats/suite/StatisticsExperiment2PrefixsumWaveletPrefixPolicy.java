...
public class StatisticsExperiment2PrefixsumWaveletPrefixPolicy extends AbstractStatsExperiment2Builder
        implements IPrefixSumWaveletBuilder, IPrefixMergePolicy {

    public StatisticsExperiment2PrefixsumWaveletPrefixPolicy(LSMExperimentSetRunnerConfig config,
