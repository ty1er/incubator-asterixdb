...
public class StatisticsExperiment3Wavelet extends AbstractStatsExperiment3Builder
        implements IWaveletBuilder, IPrefixMergePolicy {

    public StatisticsExperiment3Wavelet(LSMExperimentSetRunnerConfig config, CloseableHttpClient httpClient) {
