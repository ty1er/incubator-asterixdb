...
public class PresetClusterPerfBuilder extends AbstractExperimentBuilder {
    ...
    @Override protected void doBuild(Experiment e) throws IOException, JAXBException {
        ...
        //execute SQL++ Queries
        execs.addLast(new TimedAction(new RunSQLPPFileAction(httpClient, restHost, restPort,
                localExperimentRoot.resolve(LSMExperimentConstants.AQL_DIR).resolve(querySQLPPFileName),
