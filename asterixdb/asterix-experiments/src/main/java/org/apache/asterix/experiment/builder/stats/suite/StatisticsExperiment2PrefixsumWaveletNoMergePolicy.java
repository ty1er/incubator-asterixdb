...
public class StatisticsExperiment2PrefixsumWaveletNoMergePolicy extends AbstractStatsExperiment2Builder
        implements IPrefixSumWaveletBuilder, INoMergePolicy {

    public StatisticsExperiment2PrefixsumWaveletNoMergePolicy(LSMExperimentSetRunnerConfig config,
