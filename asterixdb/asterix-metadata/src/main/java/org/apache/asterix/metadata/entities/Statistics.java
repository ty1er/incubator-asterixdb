...
public class Statistics implements IMetadataEntity<Statistics> {
    ...
    @Override
    public Statistics addToCache(MetadataCache cache) {
        return cache.addStatisticsIfNotExists(this);
    }

    @Override
    public Statistics dropFromCache(MetadataCache cache) {
