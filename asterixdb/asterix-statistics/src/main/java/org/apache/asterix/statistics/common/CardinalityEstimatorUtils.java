...
public class CardinalityEstimatorUtils {

    public static void inferCardinality(ILogicalOperator op, CardinalityInferenceVisitor visitor)
            throws AlgebricksException {
        for (Mutable<ILogicalOperator> childOp : op.getInputs()) {
            inferCardinality(childOp.getValue(), visitor);
        }
        Long cardinality = op.accept(visitor, null);
