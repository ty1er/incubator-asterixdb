...
public class AccessMethodAnalysisContext {
    ...
    public void setIndexOnlyPlanInfo(boolean isIndexOnlyPlan, boolean secondaryKeyFieldUsedAfterSelectOrJoinOp,
            boolean requireVerificationAfterSIdxSearch, boolean doesSIdxSearchCoverAllPredicates) {
        this.indexOnlyPlanInfo.setFirst(isIndexOnlyPlan);
        this.indexOnlyPlanInfo.setSecond(secondaryKeyFieldUsedAfterSelectOrJoinOp);
        this.indexOnlyPlanInfo.setThird(requireVerificationAfterSIdxSearch);
        this.indexOnlyPlanInfo.setFourth(doesSIdxSearchCoverAllPredicates);
    }
