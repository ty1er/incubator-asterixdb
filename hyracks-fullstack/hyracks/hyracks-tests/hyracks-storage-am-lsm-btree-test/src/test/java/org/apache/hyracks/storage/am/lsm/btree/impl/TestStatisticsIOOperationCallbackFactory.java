...
public class TestStatisticsIOOperationCallbackFactory implements ILSMIOOperationCallbackFactory {
    @Override
    ...
    public ILSMIOOperationCallback createIoOpCallback(ILSMIndex index, IStatisticsManager statisticsManager)
        ...
        return new StatisticsMessageIOOperationCallbackWrapper(
                NoOpIOOperationCallbackFactory.INSTANCE.createIoOpCallback(index, statisticsManager),
                statisticsManager);
    }
}
